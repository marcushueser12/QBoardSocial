...
export function CommunityBoardClient({
  community,
  question,
  myAnswer,
  userId,
    ...
    return (
      <div className="rounded-lg border border-gray-200 p-6 dark:border-gray-800">
        <p className="text-gray-600 dark:text-gray-400">
          No question for today in this community yet.
        </p>
      </div>
    );
  }
      ...
      <div>
        ...
        <form onSubmit={handleSubmitAnswer} className="mt-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 rounded-lg bg-gray-900 px-4 py-2 text-white hover:bg-gray-800 disabled:opacity-50"
          >
              ...
              >
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                    {a.profile?.is_anonymous ? "Anonymous" : a.profile?.username || "Unknown"}
                  </p>
                  <LikeButton
                    answerId={a.id}
                    userId={userId}
